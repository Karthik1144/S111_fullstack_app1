pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://13.232.189.17:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Karthik1144/S111_fullstack_app1.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://13.232.189.17:9090/springapp1"
            echo "✅ Frontend deployed: http://13.232.189.17:9090/frontapp1"
        }
        failure {
